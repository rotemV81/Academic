...
DATA_PATH = '/home/rotem/Private/Academic/Acne04/Classification/JPEGImages'
...
def trainval_test(cross_val_index, sigma, lam):
    ...
    TRAIN_FILE = '/home/rotem/Private/Academic/Acne04/Detection/VOC2007/ImageSets/Main/NNEW_trainval_' + cross_val_index + '.txt'
    ...
    TEST_FILE = '/home/rotem/Private/Academic/Acne04/Detection/VOC2007/ImageSets/Main/NNEW_test_' + cross_val_index + '.txt'
    ...
    for epoch in range(lr_steps[-1]):#(EPOCH):#
        ...
        for step, (b_x, b_y, b_l) in enumerate(train_loader):   # gives batch data, normalize x when iterate train_loader
            ...
            # [Rotem]: original was: cls, cou, cou2cls = cnn(b_x, None)nn output
